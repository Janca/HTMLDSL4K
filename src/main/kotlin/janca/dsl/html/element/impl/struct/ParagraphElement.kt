...
interface ParagraphElementProvider : IElement {
    fun p(text: String? = null, className: String? = null, id: String? = null, init: ParagraphElement.() -> Unit = {}) = addChild(ParagraphElement().init(className = className, id = id, text = text, init = init))
}