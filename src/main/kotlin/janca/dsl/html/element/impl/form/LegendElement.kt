...
interface LegendElementProvider : IElement {
    fun legend(className: String? = null, id: String? = null, text: String? = null, init: (LegendElement.() -> Unit)? = null) = addChild(LegendElement().init(className = className, id = id, text = text, init = init))
}