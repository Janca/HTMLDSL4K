...
interface BodyElementProvider : IElement {
    fun body(className: String? = null, id: String? = null, text: String? = null, init: BodyElement.() -> Unit = {}) = addChild(BodyElement().init(className = className, id = id, text = text, init = init))
}