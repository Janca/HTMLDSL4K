...
interface PreFormattedTextElementProvider : IElement {
    fun pre(className: String? = null, id: String? = null, text: String? = null, init: (PreFormattedTextElement.() -> Unit)? = null) = addChild(PreFormattedTextElement().init(className = className, id = id, text = text, init = init))
}